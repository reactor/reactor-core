...
public class DefaultContextExpectationsTest {
	...
	private void assertContextExpectation(
		...
		final DefaultContextExpectations<Integer> base = new DefaultContextExpectations<>(step, new ErrorFormatter(null, null));
	...
	public void notContextAccessibleDueToPublisher() {
		...
		DefaultContextExpectations<Integer> expectations = new DefaultContextExpectations<>(step, new ErrorFormatter(null, null));
	...
	public void notMatchesWithDescriptionAndScenarioName() {
		...
		Step<Integer> step = StepVerifier.create(source);
		final DefaultContextExpectations<Integer> base = new DefaultContextExpectations<>(step, new ErrorFormatter("scenario", null));
