 ...
 * suffix after the snapshot qualifier (either {@code .BUILD-SNAPSHOT} or {@code -SNAPSHOT}),
 * in order to generate branch-specific snapshots that can be used to eg. validate a PR.
 * <p>
