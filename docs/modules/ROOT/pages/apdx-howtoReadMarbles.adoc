...
image::legend-operator-method.svg[A common operator]
...
image::legend-operator-static.svg[A static operator]
...
image::legend-operator-double-source.svg[An operator with two examples of input]
...
image::legend-operator-parallel.svg[A parallel operator]
...
image::legend-operator-windowing.svg[The output of a windowing operator]
...
image::legend-operator-companion.svg[An operator with a companion Publisher]
...
image::legend-events.svg[All types of signals and events]
...
image::legend-sideEffects1.svg[Side effects: representation of doOn* handlers]
image::legend-sideEffects2.svg[Side effects: in a diagram]
