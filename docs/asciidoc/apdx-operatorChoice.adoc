...
* created from expanding paginated objects into a Flux of pages content: https://projectreactor.io/docs/core/release/api/reactor/core/publisher/Flux.html#fromPaginated-P-java.util.function.Function-java.util.function.Function-[Flux#fromPaginated]
