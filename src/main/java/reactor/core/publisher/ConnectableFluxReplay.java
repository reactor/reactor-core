...
final class ConnectableFluxReplay<T> extends ConnectableFlux<T>
	...
	static final AtomicReferenceFieldUpdater<ConnectableFluxReplay, State> CONNECTION =
			AtomicReferenceFieldUpdater.newUpdater(ConnectableFluxReplay.class,
					State.class,
					"connection");
	...
	static final class State<T>
		...
		final ConnectableFluxReplay<T>        parent;
		...
		public State(ReplayProcessor.ReplayBuffer<T> buffer,
				ConnectableFluxReplay<T> parent) {
			this.buffer = buffer;
			this.parent = parent;
