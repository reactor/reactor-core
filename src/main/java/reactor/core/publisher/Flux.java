...
//	 ==============================================================================================================
	 ...
	 */
	public static <T> Flux<T> using(Supplier<? extends
			Publisher<? extends T>> sourceSupplier, Runnable resourceCleanup) {
		return using(NOOP_CALLABLE, d -> sourceSupplier.get(), d -> resourceCleanup.run
				(), true);
	}
...
//	 ==============================================================================================================
	...
	static final Callable<Object>        NOOP_CALLABLE       = () -> null;
