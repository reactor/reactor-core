 ...
 */
final class ComputationScheduler implements Scheduler {
	...
	static final AtomicReferenceFieldUpdater<ComputationScheduler, ExecutorService[]>
			EXECUTORS = AtomicReferenceFieldUpdater.newUpdater(ComputationScheduler.class,
	...
	ComputationScheduler(int n, int bufferSize, ThreadFactory factory, WaitStrategy waitStrategy) {
		if (n <= 0) {
	...
	static final class ParallelWorker implements Worker {
		...
		static final class ParallelWorkerTask implements Runnable, Cancellation {
			...
			static final AtomicReferenceFieldUpdater<ParallelWorkerTask, Future> FUTURE =
					AtomicReferenceFieldUpdater.newUpdater(ParallelWorkerTask.class,
							Future.class,
							"future");
