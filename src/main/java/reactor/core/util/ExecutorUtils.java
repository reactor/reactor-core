...
public enum ExecutorUtils {
	...
	/**
	 * Transform an executor Service into a scheduler ready to be used by
	 * {@link reactor.core.publisher.Flux#dispatchOn(Callable)} or {@link reactor.core.publisher.Flux#publishOn(Callable)}
	 *
	 * @param service the
	 * {@link ExecutorService} to turn into a scheduler (a {@link Callable} {@link Consumer} {@link Runnable}
	 * @return a new scheduler as {@link Callable}
	 */
	public static Callable<? extends Consumer<Runnable>> schedulerFromExecutor(ExecutorService service) {
	...
	static final class ExecutorServiceScheduler implements Callable<Consumer<Runnable>> {

		final ExecutorService executor;

		ExecutorServiceScheduler(ExecutorService executor) {
