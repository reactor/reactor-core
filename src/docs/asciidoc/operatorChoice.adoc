...
* I want to expand elements in a sequence into new sequences and emit the combination recursively...
** ...breadth first: `expand(Function)`
** ...choosing the recursion strategy: `expand(Function, ExpandStrategy)`
