...
s.subscribe(i -> System.out.println(Thread.currentThread() + " data=" + i)); // <3>
s.subscribe(i -> System.out.println(Thread.currentThread() + " data=" + i)); // <4>
s.subscribe(i -> System.out.println(Thread.currentThread() + " data=" + i)); // <5>
