...
----
image::https://raw.githubusercontent.com/reactor/reactor-core/v3.1.0.M1/src/docs/marble/gs-transform.png[Transform Operator : encapsulate flows]
...
----
image::https://raw.githubusercontent.com/reactor/reactor-core/v3.1.0.M1/src/docs/marble/gs-compose.png[Compose Operator : Per Subscriber transformation]
...
image::https://raw.githubusercontent.com/reactor/reactor-core/v3.1.0.M1/src/docs/marble/gs-cold.png[Replaying behavior]
...
----
image::https://raw.githubusercontent.com/reactor/reactor-core/v3.1.0.M1/src/docs/marble/gs-hot.png[Broadcasting a subscription]
