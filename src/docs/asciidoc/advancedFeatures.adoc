...
Reactor. At best, they introduce new challenges, and, at worst, they work badly or even
fail. Using the MDC of Logback to store and log correlation IDs is a prime example of
such a situation.
