...
image::https://raw.githubusercontent.com/reactor/reactor-core/v3.1.0.M1/src/docs/marble/flux.png[Flux]
...
image::https://raw.githubusercontent.com/reactor/reactor-core/v3.1.0.M1/src/docs/marble/mono.png[Mono]
...
==== Catch and rethrow
That last line inside the previous `flatMap` gives us an hint as to how item
