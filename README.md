...
dependencies {
    compile "io.projectreactor:reactor-core:3.6.0-M1"
    testCompile "io.projectreactor:reactor-test:3.6.0-M1"
    ...
    // implementation "io.projectreactor:reactor-tools:3.6.0-M1"
}
```
