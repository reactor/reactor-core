...
dependencies {
    compile "io.projectreactor:reactor-core:3.6.1"
    testCompile "io.projectreactor:reactor-test:3.6.1"

    // Alternatively, use the following for latest snapshot artifacts in this line
    // compile "io.projectreactor:reactor-core:3.6.2-SNAPSHOT"
    // testCompile "io.projectreactor:reactor-test:3.6.2-SNAPSHOT"

    // Optionally, use `reactor-tools` to help debugging reactor code
    // implementation "io.projectreactor:reactor-tools:3.6.1"
}
```
