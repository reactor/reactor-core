...
//      maven { url 'https://repo.spring.io/snapshot' }
    ...
    dependencies {
      //compile "io.projectreactor:reactor-core:3.2.13.BUILD-SNAPSHOT"
      //testCompile("io.projectreactor:reactor-test:3.2.13.BUILD-SNAPSHOT")
      compile "io.projectreactor:reactor-core:3.2.12.RELEASE"
      testCompile("io.projectreactor:reactor-test:3.2.12.RELEASE")
    }
```
