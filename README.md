<img align="left" width="150" height="150" src="/docs/asciidoc/images/logo.png">
...
dependencies {
    compile "io.projectreactor:reactor-core:3.5.0-M1"
    testCompile "io.projectreactor:reactor-test:3.5.0-M1"
    ...
    // implementation "io.projectreactor:reactor-tools:3.5.0-M1"
}
```
