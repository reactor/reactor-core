...
//      maven { url 'https://repo.spring.io/snapshot' }
    ...
    dependencies {
      //compile "io.projectreactor:reactor-core:3.2.15.BUILD-SNAPSHOT"
      //testCompile("io.projectreactor:reactor-test:3.2.15.BUILD-SNAPSHOT")
      compile "io.projectreactor:reactor-core:3.2.14.RELEASE"
      testCompile("io.projectreactor:reactor-test:3.2.14.RELEASE")
    }
```
