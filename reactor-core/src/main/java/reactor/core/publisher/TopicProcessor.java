 ...
 * loops.
 * <p>
 * <img width="640" src="https://raw.githubusercontent.com/reactor/reactor-core/v3.1.0.RC1/src/docs/marble/topic.png" alt="">
 * <p>
 ...
 * <img width="640" src="https://raw.githubusercontent.com/reactor/reactor-core/v3.1.0.RC1/src/docs/marble/topics.png" alt="">
 * <p>
 * The processor
...
public final class TopicProcessor<E> extends EventLoopProcessor<E>  {
	...
	/**
	 * Create a new TopicProcessor using {@link Queues#BUFFER_SIZE} backlog size,
