 ...
 * @author Simon Baslé
 */
public class MonoMetricsFuseable<T> extends MonoOperator<T, T> implements Fuseable {
	...
	public void subscribe(CoreSubscriber<? super T> actual) {
		...
		if (reactor.util.Metrics.isMicrometerAvailable()) {
			metricsOperator = new MicrometerMetricsFuseableSubscriber<>(actual, Metrics.globalRegistry,
