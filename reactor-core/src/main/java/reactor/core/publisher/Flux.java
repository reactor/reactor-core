...
//	 ==============================================================================================================
	 ...
	 * <p>
	 * <img class="marble" src="doc-files/marbles/combineLatestFixedSources.svg" alt="">
	 *
	 * @reactor.discard This operator is NOT suited for types that need guaranteed discard of unpropagated elements, as
	 * it doesn't track which elements have been used by the combinator and which haven't. Furthermore, elements can and
	 * will be passed to the combinator multiple times.
	 ...
	 * <p>
	 * <img class="marble" src="doc-files/marbles/combineLatestIterableSources.svg" alt="">
	 *
	 * @reactor.discard This operator is NOT suited for types that need guaranteed discard of unpropagated elements, as
	 * it doesn't track which elements have been used by the combinator and which haven't. Furthermore, elements can and
	 * will be passed to the combinator multiple times.
	 ...
	 * <p>
	 * <img class="marble" src="doc-files/marbles/concatIterableSources.svg" alt="">
	 *
	 ...
	 * forwarded downstream.
	 * <p>
	 * <img class="marble" src="doc-files/marbles/concatAyncSources.svg" alt="">
	 *
