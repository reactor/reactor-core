...
//            .flatMapSequential(l -> Flux.fromIterable(l).flatMap(i -> Mono.just(i).delayElement(Duration.ofSeconds(1))), 1, 1)
...
//		Flux.never().windowTimeout(100, Duration.ofMillis(100), true).subscribe();
		Flux.never()
//			.doOnRequest(r -> System.out.println("NEVER Requested " + r))
		    .windowTimeout(100, Duration.ofMillis(100), true)
//			.doOnRequest(r -> System.out.println("WINDOW Requested " + r))
		    .flatMap(f -> f.then(Mono.just(1))
//		                      .doOnEach(s -> {
//			                      if (s.isOnNext()) {
...
//		                      })//, 1, 1
		    ,1, 1)
//			.doOnRequest(r -> System.out.println("FLATMAP Requested " + r))
...
//		Flux.range(0, 1000)
//		    .flatMapSequential(i -> {
//				if (i % 10 == 0) return Mono.just(i).delayElement(Duration.ofMillis(10000));
//				else return Mono.just(i);
//			}, 1, 1)
//			.delayElements(Duration.ofMillis(10))
//		    .bufferTimeout(1000, Duration.ofMillis(100))
//		    .subscribe(System.out::println, System.err::println, () -> System.out.println("DONEZO"));
