...
final class MonoContextWriteRestoringThreadLocalsFuseable<T> extends MonoOperator<T, T>
		implements Fuseable {

	final Function<Context, Context> doOnContext;

	MonoContextWriteRestoringThreadLocalsFuseable(Mono<? extends T> source,
