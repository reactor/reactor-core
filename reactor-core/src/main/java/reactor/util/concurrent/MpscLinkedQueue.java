...
final class MpscLinkedQueue<E> extends AbstractQueue<E> implements BiPredicate<E, E> {
        ...
        private static final AtomicReferenceFieldUpdater<MpscLinkedQueue, LinkedQueueNode> PRODUCER_NODE_UPDATER
        ...
        private static final AtomicReferenceFieldUpdater<MpscLinkedQueue, LinkedQueueNode> CONSUMER_NODE_UPDATER
