...
//import reactor.core.publisher.FluxMergeComparingTest.Person;
//import reactor.core.publisher.FluxMergeComparingTest.User;
...
//
//		FluxMergeComparing.mergeComparingMainProducer<Integer> test =
//				new FluxMergeComparing.mergeComparingMainProducer<Integer>(actual, Comparator.naturalOrder(), 123, 4, true, true);
//
...
//	void scanInner() {
//		CoreSubscriber<? super Integer> actual = new LambdaSubscriber<>(null, null, null, null);
//		FluxMergeComparing.mergeComparingMainProducer<Integer> main =
//				new FluxMergeComparing.mergeComparingMainProducer<Integer>(actual, Comparator.naturalOrder(), 123, 4, true, true);
//
//		FluxMergeComparing.mergeComparingInnerSubscriber<Integer> test = new FluxMergeComparing.mergeComparingInnerSubscriber<>(
//				main, 123);
