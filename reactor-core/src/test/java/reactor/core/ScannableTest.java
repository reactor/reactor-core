...
public class ScannableTest {
	...
	public void taggedParallelFluxTest() {
		...
		assertThat(scannedTags1.iterator()).toIterable().containsExactlyInAnyOrder(Tuples.of("1", "One"));
